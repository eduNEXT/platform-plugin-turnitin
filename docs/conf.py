...
"""
platform-plugin-turnitin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-turnitin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-plugin-turnitin",
...
#
# html_title = 'platform-plugin-turnitin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Open edX Django plugin for Turnitin integrations using Open edX Filters.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_turnitin'),
                os.path.join(root_path, 'platform_plugin_turnitin/migrations')])
